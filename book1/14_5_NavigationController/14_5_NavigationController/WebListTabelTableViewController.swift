//
//  WebListTabelTableViewController.swift
...
class WebListTabelTableViewController: UITableViewController {
    let webList = [
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return webList.count    //섹션 내의 행 수
    }
